...
func EditFile(input json.RawMessage) (string, error) {
	...
	const replaceAllMatchesConstant = -1
	newContent := strings.Replace(oldContent, editFileInput.OldStr, editFileInput.NewStr, replaceAllMatchesConstant)
...
func (agent *Agent) Run(ctx context.Context) error {
	...
	for {
		...
		// Otherwise, we have tool results to process
		readUserInput = false
